...
test('Verify the desk configuration page and add configuration button', async ({ testLogin, testBaseurl }) => {
 test.setTimeout(60000); // ← extend test limit  
    ...
    await expect(page.locator('h1')).toHaveText('Add Configuration');
